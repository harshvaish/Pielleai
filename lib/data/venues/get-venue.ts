  ...
  try {
    ...
    const venueResult = await database
      .select({
        ...
        addressFormatted: venues.addressFormatted,
        streetName: venues.streetName,
        ...
        billingAddressFormatted: venues.billingAddressFormatted,
        billingStreetName: venues.billingStreetName,
        billingStreetNumber: venues.billingStreetNumber,
        billingPlaceId: venues.billingPlaceId,
        billingLatitude: venues.billingLatitude,
        billingLongitude: venues.billingLongitude,
        billingCountryName: venues.billingCountryName,
        billingCountryCode: venues.billingCountryCode,
        billingCountry: {
