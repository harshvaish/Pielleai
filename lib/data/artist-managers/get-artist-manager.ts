  ...
  try {
    ...
    const userResult = await database
      .select({
        ...
        addressFormatted: profiles.addressFormatted,
        streetName: profiles.streetName,
        streetNumber: profiles.streetNumber,
        placeId: profiles.placeId,
        latitude: profiles.latitude,
        longitude: profiles.longitude,
        countryName: profiles.countryName,
        ...
        billingAddressFormatted: profiles.billingAddressFormatted,
        billingStreetName: profiles.billingStreetName,
        billingStreetNumber: profiles.billingStreetNumber,
        billingPlaceId: profiles.billingPlaceId,
        billingLatitude: profiles.billingLatitude,
        billingLongitude: profiles.billingLongitude,
        billingCountryName: profiles.billingCountryName,
        billingCountryCode: profiles.billingCountryCode,
        billingCountry: {
