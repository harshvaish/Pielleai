  ...
  try {
    ...
    let baseQuery = database
      .select({
        ...
        cancellationUserId: events.cancellationUserId,
        cancellationUserRole: events.cancellationUserRole,
        cancellationNotes: events.cancellationNotes,
        cancellationAccountingCompleted: events.cancellationAccountingCompleted,
        cancellationAccountingCompletedAt: events.cancellationAccountingCompletedAt,
        cancellationLegalEmailSentAt: events.cancellationLegalEmailSentAt,
        cancellationLegalEmailTo: events.cancellationLegalEmailTo,
