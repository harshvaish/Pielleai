...
function getFormFieldsForStep(step: number): Array<keyof ArtistFormSchema> {
  if (step === 1) {
    return Object.keys(artistFormS1Schema.shape) as Array<
      keyof ArtistFormSchema
    >;
  }
  if (step === 2) {
    return Object.keys(artistFormS2Schema.shape) as Array<
      keyof ArtistFormSchema
    >;
  }
  if (step === 3) {
    return Object.keys(artistFormS3Schema.shape) as Array<
      keyof ArtistFormSchema
    >;
  }
  return [];
