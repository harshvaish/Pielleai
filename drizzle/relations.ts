...
import { artists, artistAvailabilities, users, sessions, accounts, countries, subdivisions, profiles, profileNotes, artistNotes, venues, artistZones, zones, managerArtists, artistLanguages, languages, profileLanguages } from "./schema";

export const artistAvailabilitiesRelations = relations(artistAvailabilities, ({one}) => ({
	artist: one(artists, {
