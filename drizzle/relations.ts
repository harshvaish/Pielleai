...
export const artistsRelations = relations(artists, ({one, many}) => ({
	...
	events: many(events),
	// eventGuests: many(eventGuests), // Removed: eventGuests is not defined
	// eventProfessionals: many(eventProfessionals), // Removed: eventProfessionals is not defined
	// eventReviews: many(eventReviews), // Removed: eventReviews is not defined
