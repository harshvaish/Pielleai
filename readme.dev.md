...
CRON JOB
There is one cron job on supabase extension called handle_availabilities_and_events_ends; it handles all the expiration; it runs every day at midnight UTC
